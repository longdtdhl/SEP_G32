...
public class Schedule : BaseEntity
{
    ...
    /// <summary>Consultation mode for slots generated by this schedule (Online, Offline, Both)</summary>
...
public class AppointmentSlot : BaseEntity
{
    ...
    public AppointmentSlotStatus Status { get; set; } = AppointmentSlotStatus.Available;
        /// <summary>
        /// Consultation mode for this slot (Online, Offline, Both)
        /// </summary>
        public ConsultationMode ConsultationMode { get; set; } = ConsultationMode.Both;
        /// <summary>
        /// Title of a required pre‑appointment evaluation note (shown to patient before booking)
        /// </summary>
        public string? PreAppointmentNoteTitle { get; set; }
        /// <summary>
        /// Indicates if the pre‑appointment note is mandatory for booking this slot
        /// </summary>
    ...
    /// <summary>Internal schedule notes attached to this slot.</summary>
...
public class Appointment : BaseEntity
{
    ...
    /// <summary>Zalo contact number supplied for this appointment.</summary>
    ...
    /// <summary>
    /// Selected consultation mode for this appointment (Online or Offline)
    /// </summary>
