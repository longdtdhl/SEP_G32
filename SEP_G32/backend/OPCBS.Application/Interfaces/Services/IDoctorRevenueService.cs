...
public class DoctorPayoutInfoDto
{
    ...
    public string BankAccountNumber { get; set; } = "**** **** 8899";
...
public interface IDoctorRevenueService
{
    Task<ApiResponse<DoctorRevenueOverviewDto>> GetRevenueOverviewAsync(
        Guid doctorUserId,
    ...
    Task<ApiResponse<List<DoctorRevenueTransactionDto>>> GetTransactionsAsync(
        Guid doctorUserId,
        string? search = null,
